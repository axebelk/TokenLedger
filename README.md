<p align="center">
  <a href="https://github.com/axebelk/TokenLedger"><img alt="TokenLedger logo" src="https://raw.githubusercontent.com/axebelk/TokenLedger/main/apps/web/public/logo.svg" width="120"></a>
</p>
...
<p align="center">
  ...
  Point your AI SDKs at the TokenLedger Gateway instead of the provider, and know exactly
...
<p align="center">
  <a href="https://github.com/axebelk/TokenLedger/blob/main/LICENSE"><img alt="License: Apache-2.0" src="https://img.shields.io/badge/License-Apache_2.0-green.svg"></a>
  <a href="https://github.com/axebelk/TokenLedger/releases"><img alt="Release" src="https://img.shields.io/github/v/release/axebelk/TokenLedger"></a>
  <a href="https://github.com/axebelk/TokenLedger/actions/workflows/ci.yml"><img alt="Tests" src="https://img.shields.io/github/actions/workflow/status/axebelk/TokenLedger/ci.yml?branch=main&label=tests"></a>
  <a href="https://github.com/axebelk/TokenLedger/actions/workflows/codeql.yml"><img alt="CodeQL" src="https://img.shields.io/github/actions/workflow/status/axebelk/TokenLedger/codeql.yml?branch=main&label=codeql"></a>
  <a href="https://securityscorecards.dev/viewer/?uri=github.com/axebelk/TokenLedger"><img alt="OpenSSF Scorecard" src="https://api.securityscorecards.dev/projects/github.com/axebelk/TokenLedger/badge"></a>
  <a href="https://github.com/axebelk/TokenLedger/issues"><img alt="Issues" src="https://img.shields.io/github/issues/axebelk/TokenLedger"></a>
  <a href="https://github.com/axebelk/TokenLedger/blob/main/CONTRIBUTING.md"><img alt="PRs welcome" src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg"></a>
  <a href="https://github.com/axebelk/TokenLedger/commits/main"><img alt="Last commit" src="https://img.shields.io/github/last-commit/axebelk/TokenLedger"></a>
</p>

<p align="center">
  <a href="https://github.com/axebelk/TokenLedger/pkgs/container/tokenledger-api"><img alt="ghcr.io: api" src="https://img.shields.io/badge/ghcr.io-tokenledger--api-blue"></a>
  <a href="https://github.com/axebelk/TokenLedger/pkgs/container/tokenledger-gateway"><img alt="ghcr.io: gateway" src="https://img.shields.io/badge/ghcr.io-tokenledger--gateway-blue"></a>
  <a href="https://github.com/axebelk/TokenLedger/pkgs/container/tokenledger-worker"><img alt="ghcr.io: worker" src="https://img.shields.io/badge/ghcr.io-tokenledger--worker-blue"></a>
  <a href="https://github.com/axebelk/TokenLedger/pkgs/container/tokenledger-web"><img alt="ghcr.io: web" src="https://img.shields.io/badge/ghcr.io-tokenledger--web-blue"></a>
</p>
...
which projects are burning budget**. TokenLedger is an open-source, self-hostable
control plane that sits between your application and the AI provider:

```
┌─────────────────┐      tt_live_ key        ┌──────────────────┐    real key    ┌────────────┐
│  Your app / SDK │ ───────────────────────▶ │ TokenLedger       │ ─────────────▶ │  Provider  │
...
approximation, no per-call fees — TokenLedger stores every usage event
...
```bash
git clone https://github.com/axebelk/TokenLedger.git
cd TokenLedger
cp .env.example .env
...
echo 'DOMAIN=tokenledger.example.com' >> .env
echo 'PUBLIC_BASE_URL=https://tokenledger.example.com' >> .env
...
conventional commit messages — see the [Releases page](https://github.com/axebelk/TokenLedger/releases)
...
`tokenledger-api`, `tokenledger-gateway`, `tokenledger-worker`, `tokenledger-web`
...
- `ee/` is the **TokenLedger Enterprise License** (commercial) — see [ee/LICENSE](ee/LICENSE).
